...
# Detective, except:
# - use nprtt forgive-once instead of tit-for-tat for the forgiveness heuristic
...
def strategy(history, memory):
    ...
    :memory: mode string - 'nprtt', 'alternate', 'defect', or 'tit-for-tat'
    """
    ...
    if num_rounds < len(testing_schedule):  # intitial testing phase
        ...
        if memory == "defect":
            ...
            if opponents_last_move == 0 and choice == 1:
                memory = "tit-for-tat"
            else:
                memory = "nprtt"
