def strategy(history, memory):
    """
    Nice Patient First Impressions Tit for Tat (NPFITT):
        ...
        3. First Impressions: If they defected on the first move, never trust them.
            Ever. (This prevents us from being burned by Alays Defect.)
    ...
    Tat: Tit for Tat has a low-scoring "win" vs. joss. NPFITT, on the other hand, has
    ...
    # in memory, we track whether the opponent cooperated on the first turn
    if memory is None and num_rounds == 1:
        memory = opponents_last_move == 1
